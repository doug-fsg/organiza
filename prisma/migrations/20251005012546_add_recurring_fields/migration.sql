...
INSERT INTO "new_subtasks" ("actualHours", "approvedAt", "approvedBy", "assignedToId", "completedAt", "createdAt", "deadline", "description", "estimatedHours", "id", "mainTaskId", "priority", "rejectedAt", "rejectedBy", "rejectionReason", "requiresApproval", "status", "title", "updatedAt") SELECT "actualHours", "approvedAt", "approvedBy", "assignedToId", "completedAt", "createdAt", "deadline", "description", "estimatedHours", "id", "mainTaskId", "priority", "rejectedAt", "rejectedBy", "rejectionReason", "requiresApproval", "status", "title", "updatedAt" FROM "subtasks";
DROP TABLE "subtasks";
